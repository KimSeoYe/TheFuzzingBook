...
set_configs (test_config_t * config)
{
    ...
    strcpy(config->runargs.binary_path, "../../lib/cJSON/MJ/MJ_testCJSON") ;
    config->covargs.source_num = 1 ;
    strcpy(config->covargs.source_dir, "../../lib/cJSON/MJ/") ;
    ...
    strcpy(config->covargs.source_paths[0], "../../lib/cJSON/MJ/cJSON.c") ;

    strcpy(config->fuzargs.seed_dir, "./testprogram_seeds/seed_MJ") ;
}
