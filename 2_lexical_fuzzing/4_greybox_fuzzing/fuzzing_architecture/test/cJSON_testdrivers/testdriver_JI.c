...
set_configs (test_config_t * config)
{
    ...
    strcpy(config->runargs.binary_path, "../../lib/cJSON/JI/JI_json_parser") ;
    config->covargs.source_num = 1 ;
    strcpy(config->covargs.source_dir, "../../lib/cJSON/JI/") ;
    ...
    strcpy(config->covargs.source_paths[0], "../../lib/cJSON/JI/cJSON.c") ;
